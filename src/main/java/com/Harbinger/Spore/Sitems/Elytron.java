...
public class Elytron extends SporeBaseArmor implements CustomModelArmorData{
    private final ResourceLocation TEXTURE = ResourceLocation.parse("spore:textures/armor/elytron.png");
    public Elytron(Type type) {
        super(type, new int[]{0, 0, SConfig.SERVER.ely_durability.get(),0},new int[]{0, 0, SConfig.SERVER.ely_protection.get(), 0}, SConfig.SERVER.ely_toughness.get(), SConfig.SERVER.ely_knockback_resistance.get() /10F);
    }
