...
public class SurgeryMenu extends AbstractContainerMenu {
    ...
    public SurgeryMenu(int pContainerId, Inventory inv, BlockEntity entity) {
        ...
        addPlayerHotbar(inv);
        var itemHandler = level.getCapability(Capabilities.ItemHandler.BLOCK, blockEntity.getBlockPos(), blockEntity.getBlockState(), blockEntity, null);
        if (itemHandler == null) {
            return;
        }
        this.addSlot(new SlotItemHandler(itemHandler, 0, 7, 8));
        this.addSlot(new SlotItemHandler(itemHandler, 1, 7, 26));
        this.addSlot(new SlotItemHandler(itemHandler, 2, 7, 44));
        this.addSlot(new SlotItemHandler(itemHandler, 3, 7, 62));
        this.addSlot(new SlotItemHandler(itemHandler, 4, 25, 8));
        this.addSlot(new SlotItemHandler(itemHandler, 5, 25, 26));
        this.addSlot(new SlotItemHandler(itemHandler, 6, 25, 44));
        this.addSlot(new SlotItemHandler(itemHandler, 7, 25, 62));
        this.addSlot(new SlotItemHandler(itemHandler, 8, 43, 8));
        this.addSlot(new SlotItemHandler(itemHandler, 9, 43, 26));
        this.addSlot(new SlotItemHandler(itemHandler, 10, 43, 44));
        this.addSlot(new SlotItemHandler(itemHandler, 11, 43, 62));
        this.addSlot(new SlotItemHandler(itemHandler, 12, 61, 8));
        this.addSlot(new SlotItemHandler(itemHandler, 13, 61, 26));
        this.addSlot(new SlotItemHandler(itemHandler, 14, 61, 44));
        this.addSlot(new SlotItemHandler(itemHandler, 15, 61, 62));
        this.addSlot(new SlotItemHandler(itemHandler,  16, 97, 8){
            @Override
            public boolean mayPlace(@NotNull ItemStack stack) {
                return stack.is(blockEntity.stringLikeItem);
            }
        });
        this.addSlot(new SlotItemHandler(itemHandler, 17, 115, 8){
            @Override
            public boolean mayPlace(@NotNull ItemStack stack) {
                return stack.getItem() == Sitems.HARDENING_AGENT.get();
            }
        });
        this.addSlot(new SlotItemHandler(itemHandler, 18, 133, 8){
            @Override
            public boolean mayPlace(@NotNull ItemStack stack) {
                return stack.getItem() == Sitems.SHARPENING_AGENT.get();
            }
        });
        this.addSlot(new SlotItemHandler(itemHandler, 19, 151, 8){
            @Override
            public boolean mayPlace(@NotNull ItemStack stack) {
                return stack.getItem() == Sitems.INTEGRATING_AGENT.get();
            }
        });
        this.addSlot(new SlotItemHandler(itemHandler,  20, 124, 53){
            @Override
