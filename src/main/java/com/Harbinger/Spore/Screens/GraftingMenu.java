...
public class GraftingMenu extends AbstractContainerMenu {
    ...
    public GraftingMenu(int containerId, Inventory inv, BlockEntity entity) {
        ...
        this.addSlot(new SlotItemHandler(itemHandler, SurgeryTableBlockEntity.GRATING_ITEM_ONE, 25, 8));
        this.addSlot(new SlotItemHandler(itemHandler, SurgeryTableBlockEntity.GRATING_INGREDIENT, 25, 35));
        this.addSlot(new SlotItemHandler(itemHandler, SurgeryTableBlockEntity.GRATING_ITEM_TWO, 25, 62));
        this.addSlot(new SlotItemHandler(itemHandler, SurgeryTableBlockEntity.GRATING_OUTPUT, 88, 35) {
            @Override
