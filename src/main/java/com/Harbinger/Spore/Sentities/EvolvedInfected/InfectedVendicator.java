...
public class InfectedVendicator extends EvolvedInfected implements ArmedInfected , EvolvingInfected {
    public InfectedVendicator(EntityType<? extends Infected> type, Level level) {
        super(type, level);
    }
    ...
    protected SoundEvent getAmbientSound() {
        return Ssounds.VINDICATOR_AMBIENT.value();
    }
    ...
    public void HyperEvolve(LivingEntity living) {
        ...
        if (this.level() instanceof ServerLevel serverLevel)
            hindicator.finalizeSpawn(serverLevel,serverLevel.getCurrentDifficultyAt(this.getOnPos()), MobSpawnType.CONVERSION,null);
