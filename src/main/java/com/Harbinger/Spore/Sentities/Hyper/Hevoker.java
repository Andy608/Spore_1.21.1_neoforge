...
public class Hevoker extends Hyper {
    ...
    public void reviveBody(){
        ...
        if (source != null){
            LivingUseTotemEvent event = new LivingUseTotemEvent(this, source, stack,InteractionHand.MAIN_HAND);
    ...
    protected void addRegularGoals() {
        ...
        this.goalSelector.addGoal(2, new PullGoal(this, 32, 8){
            ...
            public void start() {
                super.start();
                mob.playSound(Ssounds.HEXEN_SUCK.value());
            }
        });
    ...
    public void performTelekineticThrow(){
        ...
        if (entities.size() > 1){
            ...
            this.playSound(Ssounds.HEXEN_BLOW.value());
        }
    }
}
