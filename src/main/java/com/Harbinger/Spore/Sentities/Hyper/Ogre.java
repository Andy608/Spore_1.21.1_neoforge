...
public class Ogre extends Hyper implements RangedAttackMob , ArmorPersentageBypass {
    ...
    protected void defineSynchedData(SynchedEntityData.@NotNull Builder builder) {
        ...
        builder.define(HAS_IMPALED_BODY, false);
    }
    ...
    public boolean doHurtTarget(Entity entity) {
        ...
        if (entity instanceof LivingEntity living){living.addEffect(new MobEffectInstance(Seffects.MYCELIUM,  600, 0), this);}
    ...
    protected SoundEvent getAmbientSound() {
        return Ssounds.OGRE_AMBIENT.value();
    }

    protected SoundEvent getHurtSound(DamageSource p_34327_) {
        return Ssounds.INF_VILLAGER_DAMAGE.value();
    }
