...
public class UndergroundMovementControl extends com.Harbinger.Spore.Sentities.MovementControls.CalamityMovementControl {
    ...
    boolean isInWall(LivingEntity mob){
        ...
        AABB aabb = AABB.ofSize(mob.getEyePosition().add(0,-0.05,0), f, 1.0E-6, f);
