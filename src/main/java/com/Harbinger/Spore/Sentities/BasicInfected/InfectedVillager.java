...
public class InfectedVillager extends Infected implements EvolvingInfected , VariantKeeper {
    ...
    public InfectedVillager(EntityType<? extends Infected> type, Level level) {
        super(type, level);
    }
    ...
    public @Nullable SpawnGroupData finalizeSpawn(ServerLevelAccessor level, DifficultyInstance difficulty, MobSpawnType spawnType, @Nullable SpawnGroupData spawnGroupData) {
        Holder<Biome> biome = level.getBiome(this.getOnPos());
        ...
        if (biome.is(Tags.Biomes.IS_CONIFEROUS_TREE)){
