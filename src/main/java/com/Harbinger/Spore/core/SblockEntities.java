...
public class SblockEntities {
    ...
    public static final Supplier<BlockEntityType<OvergrownSpawnerEntity>> OVERGROWN_SPAWNER =
    ...
    public static final Supplier<BlockEntityType<BrainRemnantBlockEntity>> BRAIN_REMNANTS =
    ...
    public static final Supplier<BlockEntityType<OutpostWatcherBlockEntity>> OUTPOST_WATCHER =
    ...
    public static final Supplier<BlockEntityType<SurgeryTableBlockEntity>> SURGERY_TABLE_ENTITY =
    ...
    public static final Supplier<BlockEntityType<CabinetBlockEntity>> CABINET_ENTITY =
