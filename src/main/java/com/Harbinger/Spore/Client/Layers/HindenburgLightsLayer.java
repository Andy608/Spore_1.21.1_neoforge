...
public class HindenburgLightsLayer<T extends Hinderburg> extends RenderLayer<T, HindieModel<T>> {
    ...
    private static final ResourceLocation MAIN_TEXTURE = ResourceLocation.fromNamespaceAndPath(Spore.MODID,"textures/entity/hindie_light/hindie_lights.png");
    ...
    public static final Map<activeLights, ResourceLocation> TEXTURE =
            Util.make(Maps.newEnumMap(activeLights.class), (p_114874_) -> {
                p_114874_.put(activeLights.RED,
                         ResourceLocation.fromNamespaceAndPath(Spore.MODID, "textures/entity/hindie_light/hindie_red.png"));
                p_114874_.put(activeLights.BLUE,
                         ResourceLocation.fromNamespaceAndPath(Spore.MODID, "textures/entity/hindie_light/hindie_blue.png"));
                p_114874_.put(activeLights.GREEN,
                         ResourceLocation.fromNamespaceAndPath(Spore.MODID, "textures/entity/hindie_light/hindie_green.png"));
                p_114874_.put(activeLights.YELLOW,
                         ResourceLocation.fromNamespaceAndPath(Spore.MODID, "textures/entity/hindie_light/hindie_yellow.png"));
            });
    ...
    public void render(PoseStack stack, MultiBufferSource bufferSource, int p_117351_, T type, float p_117353_, float p_117354_, float p_117355_, float p_117356_, float p_117357_, float p_117358_) {
        if (SConfig.SERVER.costumes.get()){
            ...
            if (j == 12 || SConfig.SERVER.costumes_active.get()){
                ...
                coloredCutoutModelCopyLayerRender(this.getParentModel(), this.model, MAIN_TEXTURE, stack, bufferSource, p_117351_, type, p_117353_, p_117354_, p_117355_, p_117356_, p_117357_, p_117358_, -1);
    ...
    public void renderActiveLight(MultiBufferSource bufferSource, PoseStack stack){
        ...
        model.renderToBuffer(stack, vertexconsumer, 15728640, OverlayTexture.NO_OVERLAY, -1);
    }
