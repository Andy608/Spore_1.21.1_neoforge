...
public class SniperSpitterModel<T extends Spitter> extends EntityModel<T> {
	...
	public static final ModelLayerLocation LAYER_LOCATION = new ModelLayerLocation( ResourceLocation.fromNamespaceAndPath(Spore.MODID, "sniperspittermodel"), "main");
	...
	public void renderToBuffer(PoseStack poseStack, VertexConsumer vertexConsumer, int packedLight, int packedOverlay, int alpha) {
		meetthesniper.render(poseStack, vertexConsumer, packedLight, packedOverlay, alpha);
	}
}