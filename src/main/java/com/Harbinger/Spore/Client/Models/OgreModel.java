...
public class OgreModel<T extends Ogre> extends EntityModel<T> implements TentacledModel{
	...
	public static final ModelLayerLocation LAYER_LOCATION = new ModelLayerLocation( ResourceLocation.fromNamespaceAndPath(Spore.MODID, "ogremodel"), "main");
	...
	public void renderToBuffer(PoseStack poseStack, VertexConsumer vertexConsumer, int packedLight, int packedOverlay, int alpha) {
		H_brute.render(poseStack, vertexConsumer, packedLight, packedOverlay, alpha);
	}
}