...
public class DualSpitterModel<T extends Spitter> extends EntityModel<T> implements TentacledModel{
	...
	public static final ModelLayerLocation LAYER_LOCATION = new ModelLayerLocation(ResourceLocation.fromNamespaceAndPath(Spore.MODID, "dualspittermodel"), "main");
	...
	public void renderToBuffer(PoseStack poseStack, VertexConsumer vertexConsumer, int packedLight, int packedOverlay, int alpha) {
		thisdoesntmakesense.render(poseStack, vertexConsumer, packedLight, packedOverlay,  alpha);
	}
}