...
public class MoundModel<T extends Mound> extends EntityModel<T> {
	...
	public static final ModelLayerLocation LAYER_LOCATION = new ModelLayerLocation( ResourceLocation.fromNamespaceAndPath(Spore.MODID, "moundmodel"), "main");
	...
	public void renderToBuffer(PoseStack poseStack, VertexConsumer vertexConsumer, int packedLight, int packedOverlay, int alpha) {
		...
		small_tendrils.render(poseStack, vertexConsumer, packedLight, packedOverlay, alpha);
		bb_main.render(poseStack, vertexConsumer, packedLight, packedOverlay, alpha);
	}
}