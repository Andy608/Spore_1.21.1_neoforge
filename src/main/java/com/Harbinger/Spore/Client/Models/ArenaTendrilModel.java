...
public class ArenaTendrilModel<T extends ArenaEntity> extends EntityModel<T> implements TentacledModel{
	...
	public static final ModelLayerLocation LAYER_LOCATION = new ModelLayerLocation(ResourceLocation.fromNamespaceAndPath(Spore.MODID, "arena_tendril"), "main");
	...
	public void renderToBuffer(PoseStack poseStack, VertexConsumer vertexConsumer, int packedLight, int packedOverlay, int alpha) {
		Tendril.render(poseStack, vertexConsumer, packedLight, packedOverlay, alpha);
	}
}