...
public class InfectedZombieVillager<T extends InfectedVillager> extends EntityModel<T> {
	...
	public static final ModelLayerLocation LAYER_LOCATION = new ModelLayerLocation( ResourceLocation.fromNamespaceAndPath(Spore.MODID, "infectedzombievillager"), "main");
