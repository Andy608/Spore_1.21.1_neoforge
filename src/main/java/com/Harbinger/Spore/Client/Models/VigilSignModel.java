...
public class VigilSignModel<T extends Vigil> extends EntityModel<T> implements TentacledModel{
	...
	public static final ModelLayerLocation LAYER_LOCATION = new ModelLayerLocation( ResourceLocation.fromNamespaceAndPath(Spore.MODID, "vigilsignmodel"), "main");
	...
	public void renderToBuffer(PoseStack poseStack, VertexConsumer vertexConsumer, int packedLight, int packedOverlay, int alpha) {
		Biomasses.render(poseStack, vertexConsumer, packedLight, packedOverlay,  alpha);
		Roots.render(poseStack, vertexConsumer, packedLight, packedOverlay, alpha);
		Body.render(poseStack, vertexConsumer, packedLight, packedOverlay, alpha);
		Limbs.render(poseStack, vertexConsumer, packedLight, packedOverlay, alpha);
		HeadPivot.render(poseStack, vertexConsumer, packedLight, packedOverlay, alpha);
		RighHolder.render(poseStack, vertexConsumer, packedLight, packedOverlay, alpha);
	}
}