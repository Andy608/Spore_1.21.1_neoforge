...
public class lacedThornsModel<T extends LivingEntity> extends EntityModel<T> {
	...
	public static final ModelLayerLocation LAYER_LOCATION = new ModelLayerLocation(ResourceLocation.fromNamespaceAndPath(Spore.MODID, "lacedthornsmodel"), "main");
	...
	public void renderToBuffer(PoseStack poseStack, VertexConsumer vertexConsumer, int packedLight, int packedOverlay, int color) {
		...
		rightDarm.render(poseStack, vertexConsumer, packedLight, packedOverlay, color);
		leftDarm.render(poseStack, vertexConsumer, packedLight, packedOverlay, color);
		rightDleg.render(poseStack, vertexConsumer, packedLight, packedOverlay, color);
		leftDleg.render(poseStack, vertexConsumer, packedLight, packedOverlay, color);
		rightDboot.render(poseStack, vertexConsumer, packedLight, packedOverlay, color);
		leftDboot.render(poseStack, vertexConsumer, packedLight, packedOverlay, color);
	}
}