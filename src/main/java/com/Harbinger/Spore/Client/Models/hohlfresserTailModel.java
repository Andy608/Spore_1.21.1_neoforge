...
public class hohlfresserTailModel<T extends HohlMultipart> extends EntityModel<T> implements TentacledModel{
	...
	public static final ModelLayerLocation LAYER_LOCATION = new ModelLayerLocation( ResourceLocation.fromNamespaceAndPath(Spore.MODID, "hohlfressertailmodel"), "main");
