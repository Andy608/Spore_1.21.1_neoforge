...
public class NuckelaveModel<T extends Nuclealave> extends HierarchicalModel<T> implements TentacledModel, ArmedModel {
	...
	public static final ModelLayerLocation LAYER_LOCATION = new ModelLayerLocation( ResourceLocation.fromNamespaceAndPath(Spore.MODID, "nuckelavemodel"), "main");
	...
	public void renderToBuffer(PoseStack poseStack, VertexConsumer vertexConsumer, int packedLight, int packedOverlay,int alpha) {
		...
		Nuckelavee.render(poseStack, vertexConsumer, packedLight, packedOverlay, alpha);
	}
