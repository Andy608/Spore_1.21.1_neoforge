...
public class InfectedHazmatWithTank<T extends InfectedHazmat> extends EntityModel<T> {
	...
	public static final ModelLayerLocation LAYER_LOCATION = new ModelLayerLocation( ResourceLocation.fromNamespaceAndPath(Spore.MODID, "infectedhazmatwithtank"), "main");
	...
	public void renderToBuffer(PoseStack poseStack, VertexConsumer vertexConsumer, int packedLight, int packedOverlay, int alpha) {
		TorsoBase.render(poseStack, vertexConsumer, packedLight, packedOverlay, alpha);
		...
		Tank.render(poseStack, vertexConsumer, packedLight, packedOverlay, alpha);
	}
}