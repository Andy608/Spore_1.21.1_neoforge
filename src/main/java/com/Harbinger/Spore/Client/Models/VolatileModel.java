...
public class VolatileModel<T extends Volatile> extends EntityModel<T> implements TentacledModel{
	...
	public static final ModelLayerLocation LAYER_LOCATION = new ModelLayerLocation(ResourceLocation.fromNamespaceAndPath(Spore.MODID, "volatilemodel"), "main");
	...
	public void renderToBuffer(PoseStack poseStack, VertexConsumer vertexConsumer, int packedLight, int packedOverlay,int alpha) {
		CuntyVolatile.render(poseStack, vertexConsumer, packedLight, packedOverlay,  alpha);
	}
}