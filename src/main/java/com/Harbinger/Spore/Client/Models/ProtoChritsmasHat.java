...
public class ProtoChritsmasHat<T extends Proto> extends EntityModel<T> {
	...
	public static final ModelLayerLocation LAYER_LOCATION = new ModelLayerLocation( ResourceLocation.fromNamespaceAndPath(Spore.MODID, "protochritsmashat"), "main");
	...
	public void renderToBuffer(PoseStack poseStack, VertexConsumer vertexConsumer, int packedLight, int packedOverlay, int alpha) {
		...
		bell.render(poseStack, vertexConsumer, packedLight, packedOverlay, alpha);
		bell2.render(poseStack, vertexConsumer, packedLight, packedOverlay, alpha);
	}
}