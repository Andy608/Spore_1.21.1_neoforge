...
public class InfectedTechnoModel<T extends InfectedPlayer> extends HumanoidModel<T> {
	...
	public static final ModelLayerLocation LAYER_LOCATION = new ModelLayerLocation( ResourceLocation.fromNamespaceAndPath(Spore.MODID, "infectedtechnomodel"), "main");
