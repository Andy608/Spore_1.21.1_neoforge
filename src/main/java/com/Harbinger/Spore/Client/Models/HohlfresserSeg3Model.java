...
public class HohlfresserSeg3Model<T extends HohlMultipart> extends EntityModel<T> implements TentacledModel {
	...
	public static final ModelLayerLocation LAYER_LOCATION = new ModelLayerLocation( ResourceLocation.fromNamespaceAndPath(Spore.MODID, "hohlfresserseg3model"), "main");
