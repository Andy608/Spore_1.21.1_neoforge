...
public class SyringeProjectileModel<T extends SyringeProjectile> extends EntityModel<T> {
	...
	public static final ModelLayerLocation LAYER_LOCATION = new ModelLayerLocation(ResourceLocation.fromNamespaceAndPath(Spore.MODID, "syringeprojectile"), "main");
	...
	public void renderToBuffer(PoseStack poseStack, VertexConsumer vertexConsumer, int packedLight, int packedOverlay, int alpha) {
		syringe.render(poseStack, vertexConsumer, packedLight, packedOverlay,  alpha);
	}
}