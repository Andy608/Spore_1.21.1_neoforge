...
public class brainMatterModel<T extends BrainRemnantBlockEntity> extends BlockEntityModel<T> {
	...
	public static final ModelLayerLocation LAYER_LOCATION = new ModelLayerLocation(ResourceLocation.fromNamespaceAndPath(Spore.MODID, "brainmattermodel"), "main");
	...
	public void renderToBuffer(PoseStack poseStack, VertexConsumer vertexConsumer, int packedLight, int packedOverlay, int alpha) {
		lobes.render(poseStack, vertexConsumer, packedLight, packedOverlay, alpha);
		lobes2.render(poseStack, vertexConsumer, packedLight, packedOverlay, alpha);
		lobes3.render(poseStack, vertexConsumer, packedLight, packedOverlay, alpha);
		lobes4.render(poseStack, vertexConsumer, packedLight, packedOverlay, alpha);
		lobes5.render(poseStack, vertexConsumer, packedLight, packedOverlay, alpha);
		lobes6.render(poseStack, vertexConsumer, packedLight, packedOverlay, alpha);
		lobes7.render(poseStack, vertexConsumer, packedLight, packedOverlay, alpha);
		lobes8.render(poseStack, vertexConsumer, packedLight, packedOverlay, alpha);
	}
}