...
public class PCI_ModelL<T extends LivingEntity> extends EntityModel<T> {
	...
	public static final ModelLayerLocation LAYER_LOCATION = new ModelLayerLocation(ResourceLocation.fromNamespaceAndPath(Spore.MODID, "pci_convertedl"), "main");
	...
	public void renderToBuffer(PoseStack poseStack, VertexConsumer vertexConsumer, int packedLight,int packedOverlay, int color) {
		PCIBODY.render(poseStack, vertexConsumer, packedLight, packedOverlay,color);
	}
}