...
public class TumoralNukeModel<T extends TumoroidNuke> extends EntityModel<T> {
	...
	public static final ModelLayerLocation LAYER_LOCATION = new ModelLayerLocation( ResourceLocation.fromNamespaceAndPath(Spore.MODID, "tumoral_nuke"), "main");
	...
	public void renderToBuffer(PoseStack poseStack, VertexConsumer vertexConsumer, int packedLight, int packedOverlay, int alpha) {
		TheFuckingNuke.render(poseStack, vertexConsumer, packedLight, packedOverlay, alpha);
	}
}