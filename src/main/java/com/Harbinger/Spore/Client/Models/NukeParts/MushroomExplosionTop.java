...
public class MushroomExplosionTop<T extends NukeEntity> extends EntityModel<T> {
	...
	public static final ModelLayerLocation LAYER_LOCATION = new ModelLayerLocation(ResourceLocation.fromNamespaceAndPath(Spore.MODID, "mushroomexplosiontop"), "main");
	...
	public void renderToBuffer(PoseStack poseStack, VertexConsumer vertexConsumer, int packedLight, int packedOverlay, int alpha) {
		top.render(poseStack, vertexConsumer, packedLight, packedOverlay, alpha);
	}
}