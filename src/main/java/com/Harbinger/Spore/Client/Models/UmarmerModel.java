...
public class UmarmerModel<T extends Umarmer> extends HierarchicalModel<T> {
	...
	public static final ModelLayerLocation LAYER_LOCATION = new ModelLayerLocation( ResourceLocation.fromNamespaceAndPath(Spore.MODID, "organoid_tendril1"), "main");
	...
	public void renderToBuffer(PoseStack poseStack, VertexConsumer vertexConsumer, int packedLight, int packedOverlay, int alpha) {
		Tendril_organoid1.render(poseStack, vertexConsumer, packedLight, packedOverlay, alpha);
	}
