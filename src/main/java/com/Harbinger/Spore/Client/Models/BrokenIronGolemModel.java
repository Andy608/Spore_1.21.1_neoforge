...
public class BrokenIronGolemModel<T extends InfestedConstruct> extends EntityModel<T> {
	...
	public static final ModelLayerLocation LAYER_LOCATION = new ModelLayerLocation(ResourceLocation.fromNamespaceAndPath(Spore.MODID, "broken_iron_golem"), "main");
	...
	public void renderToBuffer(PoseStack poseStack, VertexConsumer vertexConsumer, int packedLight, int packedOverlay, int alpha) {
		Destoryedgolem.render(poseStack, vertexConsumer, packedLight, packedOverlay, alpha);
	}
}