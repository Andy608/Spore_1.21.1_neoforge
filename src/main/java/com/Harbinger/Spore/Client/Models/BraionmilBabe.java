...
public class BraionmilBabe<T extends Braionmil> extends EntityModel<T> {
	...
	public static final ModelLayerLocation LAYER_LOCATION = new ModelLayerLocation( ResourceLocation.fromNamespaceAndPath(Spore.MODID, "braionmil"), "main");
	...
	public void renderToBuffer(PoseStack poseStack, VertexConsumer vertexConsumer, int packedLight, int packedOverlay, int alpha) {
		...
		tongueM.render(poseStack, vertexConsumer, packedLight, packedOverlay, alpha);
		lungs4.render(poseStack, vertexConsumer, packedLight, packedOverlay, alpha);
		lungs2.render(poseStack, vertexConsumer, packedLight, packedOverlay, alpha);
	}
}