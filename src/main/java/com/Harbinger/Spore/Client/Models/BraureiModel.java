...
public class BraureiModel<T extends Brauerei> extends EntityModel<T> {
	...
	public static final ModelLayerLocation LAYER_LOCATION = new ModelLayerLocation( ResourceLocation.fromNamespaceAndPath(Spore.MODID, "augeo2"), "main");
	...
	public void renderToBuffer(PoseStack poseStack, VertexConsumer vertexConsumer, int packedLight, int packedOverlay, int alpha) {
		Augeo.render(poseStack, vertexConsumer, packedLight, packedOverlay, alpha);
	}
}