...
public class BurstUsurperModel<T extends Usurper> extends EntityModel<T> implements TentacledModel{
	...
	public static final ModelLayerLocation LAYER_LOCATION = new ModelLayerLocation(ResourceLocation.fromNamespaceAndPath(Spore.MODID, "burstusurper"), "main");
	...
	public void renderToBuffer(PoseStack poseStack, VertexConsumer vertexConsumer, int packedLight, int packedOverlay, int alpha) {
		burstspitterorganoid.render(poseStack, vertexConsumer, packedLight, packedOverlay, alpha);
	}
}