...
public class InfectedHazmatCoat<T extends InfectedHazmat> extends EntityModel<T> {
	...
	public static final ModelLayerLocation LAYER_LOCATION = new ModelLayerLocation( ResourceLocation.fromNamespaceAndPath(Spore.MODID, "inf_science"), "main");
	...
	public void renderToBuffer(PoseStack poseStack, VertexConsumer vertexConsumer, int packedLight, int packedOverlay, int alpha) {
		inf_whiteguy.render(poseStack, vertexConsumer, packedLight, packedOverlay, alpha);
	}
}