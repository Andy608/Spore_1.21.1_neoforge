...
public class LeftArmModel<T extends HowitzerArm> extends EntityModel<T> {
	...
	public static final ModelLayerLocation LAYER_LOCATION = new ModelLayerLocation( ResourceLocation.fromNamespaceAndPath(Spore.MODID, "leftarmmodel"), "main");
	...
	public void renderToBuffer(PoseStack poseStack, VertexConsumer vertexConsumer, int packedLight, int packedOverlay, int alpha) {
		LeftArmJoint.render(poseStack, vertexConsumer, packedLight, packedOverlay, alpha);
	}
}