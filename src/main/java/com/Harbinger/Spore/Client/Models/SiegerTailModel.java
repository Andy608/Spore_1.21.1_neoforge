...
public class SiegerTailModel<T extends SiegerTail> extends EntityModel<T> implements TentacledModel{
	...
	public static final ModelLayerLocation LAYER_LOCATION = new ModelLayerLocation( ResourceLocation.fromNamespaceAndPath(Spore.MODID, "siegertailmodel"), "main");
	...
	public void renderToBuffer(PoseStack poseStack, VertexConsumer vertexConsumer, int packedLight, int packedOverlay, int alpha) {
		gore.render(poseStack, vertexConsumer, packedLight, packedOverlay, alpha);
		tail5.render(poseStack, vertexConsumer, packedLight, packedOverlay, alpha);
	}
}