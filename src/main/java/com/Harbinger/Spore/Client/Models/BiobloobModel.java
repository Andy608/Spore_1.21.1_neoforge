...
public class BiobloobModel<T extends Biobloob> extends EntityModel<T> implements TentacledModel {
	...
	public static final ModelLayerLocation LAYER_LOCATION = new ModelLayerLocation(ResourceLocation.fromNamespaceAndPath(Spore.MODID, "biobloobmodel"), "main");
	...
	public void renderToBuffer(PoseStack poseStack, VertexConsumer vertexConsumer, int packedLight, int packedOverlay, int alpha) {
		bioblobgoonsludge.render(poseStack, vertexConsumer, packedLight, packedOverlay, alpha);
	}
}