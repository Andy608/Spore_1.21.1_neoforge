...
public class UsurperModel<T extends Usurper> extends EntityModel<T> {
	...
	public static final ModelLayerLocation LAYER_LOCATION = new ModelLayerLocation( ResourceLocation.fromNamespaceAndPath(Spore.MODID, "spitter_organoid"), "main");
	...
	public void renderToBuffer(PoseStack poseStack, VertexConsumer vertexConsumer, int packedLight, int packedOverlay, int alpha) {
		spitterorganoid.render(poseStack, vertexConsumer, packedLight, packedOverlay, alpha);
	}
}