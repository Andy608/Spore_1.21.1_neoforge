...
public class InfestedContructModel<T extends InfestedConstruct> extends EntityModel<T> implements TentacledModel {
	...
	public static final ModelLayerLocation LAYER_LOCATION = new ModelLayerLocation(ResourceLocation.fromNamespaceAndPath(Spore.MODID, "infestedcontructmodel"), "main");
	...
	public void renderToBuffer(PoseStack poseStack, VertexConsumer vertexConsumer, int packedLight, int packedOverlay,int alpha) {
		Infgolem.render(poseStack, vertexConsumer, packedLight, packedOverlay, alpha);
	}
