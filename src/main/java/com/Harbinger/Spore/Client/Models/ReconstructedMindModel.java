...
public class ReconstructedMindModel<T extends HiveSpawnBlockEntity> extends BlockEntityModel<T> implements TentacledModel{
	...
	public static final ModelLayerLocation LAYER_LOCATION = new ModelLayerLocation(ResourceLocation.fromNamespaceAndPath(Spore.MODID, "reconstructedmindmodel"), "main");
	...
	public void renderToBuffer(PoseStack poseStack, VertexConsumer vertexConsumer, int packedLight, int packedOverlay, int alpha) {
		ReconstructedMind.render(poseStack, vertexConsumer, packedLight, packedOverlay, alpha);
	}
