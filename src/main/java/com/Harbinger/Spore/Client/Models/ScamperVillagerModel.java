...
public class ScamperVillagerModel<T extends Scamper> extends EntityModel<T> {
	...
	public static final ModelLayerLocation LAYER_LOCATION = new ModelLayerLocation( ResourceLocation.fromNamespaceAndPath(Spore.MODID, "scampervillagermodel"), "main");
	...
	public void renderToBuffer(PoseStack poseStack, VertexConsumer vertexConsumer, int packedLight, int packedOverlay, int alpha) {
		...
		mound1.render(poseStack, vertexConsumer, packedLight, packedOverlay, alpha);
		mound2.render(poseStack, vertexConsumer, packedLight, packedOverlay, alpha);
		mound3.render(poseStack, vertexConsumer, packedLight, packedOverlay, alpha);
	}
}