...
public class ProtoRedesign<T extends Proto> extends EntityModel<T> {
	...
	public static final ModelLayerLocation LAYER_LOCATION = new ModelLayerLocation( ResourceLocation.fromNamespaceAndPath(Spore.MODID, "protoredesign"), "main");
	...
	public void renderToBuffer(PoseStack poseStack, VertexConsumer vertexConsumer, int packedLight, int packedOverlay, int alpha) {
		Proto.render(poseStack, vertexConsumer, packedLight, packedOverlay, alpha);
	}
}