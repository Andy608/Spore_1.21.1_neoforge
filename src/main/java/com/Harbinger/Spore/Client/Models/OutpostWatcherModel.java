...
public class OutpostWatcherModel<T extends OutpostWatcherBlockEntity> extends BlockEntityModel<T> {
	...
	public static final ModelLayerLocation LAYER_LOCATION = new ModelLayerLocation(ResourceLocation.fromNamespaceAndPath(Spore.MODID, "outpost_watcher"), "main");
	...
	public void renderToBuffer(PoseStack poseStack, VertexConsumer vertexConsumer, int packedLight, int packedOverlay, int alpha) {
		OutpostCore.render(poseStack, vertexConsumer, packedLight, packedOverlay, alpha);
	}
