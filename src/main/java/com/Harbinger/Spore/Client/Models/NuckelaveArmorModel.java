...
public class NuckelaveArmorModel<T extends Nuclealave> extends EntityModel<T> {
	...
	public static final ModelLayerLocation LAYER_LOCATION = new ModelLayerLocation(ResourceLocation.fromNamespaceAndPath(Spore.MODID, "nuckelavearmormodel"), "main");
