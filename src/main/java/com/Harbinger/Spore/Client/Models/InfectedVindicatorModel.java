...
public class InfectedVindicatorModel<T extends InfectedVendicator> extends EntityModel<T> implements ArmedModel {
	...
	public static final ModelLayerLocation LAYER_LOCATION = new ModelLayerLocation( ResourceLocation.fromNamespaceAndPath(Spore.MODID, "infectedvindicatormodel"), "main");
