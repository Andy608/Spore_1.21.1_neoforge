...
public class GrieferModel<T extends Griefer> extends EntityModel<T> {
	...
	public static final ModelLayerLocation LAYER_LOCATION = new ModelLayerLocation(ResourceLocation.fromNamespaceAndPath(Spore.MODID, "griefermodel"), "main");
	...
	public void renderToBuffer(PoseStack poseStack, VertexConsumer vertexConsumer, int packedLight, int packedOverlay, int alpha) {
		...
		belly.render(poseStack, vertexConsumer, packedLight, packedOverlay, alpha);
		...
		tumor3.render(poseStack, vertexConsumer, packedLight, packedOverlay, alpha);
		tumor4.render(poseStack, vertexConsumer, packedLight, packedOverlay, alpha);
	}
}