...
public class GazenbrecherModel<T extends Gazenbrecher> extends HierarchicalModel<T> {
	...
	public static final ModelLayerLocation LAYER_LOCATION = new ModelLayerLocation( ResourceLocation.fromNamespaceAndPath(Spore.MODID, "gazen"), "main");
	...
	public void renderToBuffer(PoseStack poseStack, VertexConsumer vertexConsumer, int packedLight, int packedOverlay,int alpha) {
		Gazenbreacher.render(poseStack, vertexConsumer, packedLight, packedOverlay, alpha);
	}
