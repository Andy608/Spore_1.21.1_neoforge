...
public class OvergrownSpawnerModel<T extends OvergrownSpawnerEntity> extends BlockEntityModel<T> {
	...
	public static final ModelLayerLocation LAYER_LOCATION = new ModelLayerLocation(ResourceLocation.fromNamespaceAndPath(Spore.MODID, "overgrownspawnermodel"), "main");
