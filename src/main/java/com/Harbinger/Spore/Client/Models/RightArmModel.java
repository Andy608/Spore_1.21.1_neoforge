...
public class RightArmModel<T extends HowitzerArm> extends EntityModel<T> {
	...
	public static final ModelLayerLocation LAYER_LOCATION = new ModelLayerLocation(ResourceLocation.fromNamespaceAndPath(Spore.MODID, "rightarmmodel"), "main");
	...
	public void renderToBuffer(PoseStack poseStack, VertexConsumer vertexConsumer, int packedLight, int packedOverlay, int alpha) {
		RightArmJoint.render(poseStack, vertexConsumer, packedLight, packedOverlay, alpha);
	}
}