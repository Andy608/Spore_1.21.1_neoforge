...
public class LeftLegArmorPartEnchant extends BaseArmorRenderingBit implements EnchantingPart{
    ...
    public LeftLegArmorPartEnchant(Supplier<EntityModel<LivingEntity>> model, Supplier<ModelPart> part, float x, float y, float z, float expand, ResourceKey<Enchantment> enchantment, ResourceLocation location, List<Item> blacklist) {
