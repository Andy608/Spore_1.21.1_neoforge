    ...
    public static final Map<UmarmerVariants, ResourceLocation> TEXTURE =
            Util.make(Maps.newEnumMap(UmarmerVariants.class), (p_114874_) -> {
                p_114874_.put(UmarmerVariants.DEFAULT,
                         ResourceLocation.fromNamespaceAndPath(Spore.MODID, "textures/entity/umarmer.png"));
                p_114874_.put(UmarmerVariants.CHARRED,
                         ResourceLocation.fromNamespaceAndPath(Spore.MODID, "textures/entity/umarmer_crispy.png"));
                p_114874_.put(UmarmerVariants.BILE,
                         ResourceLocation.fromNamespaceAndPath(Spore.MODID, "textures/entity/umarmer_bile.png"));
                p_114874_.put(UmarmerVariants.CORROSIVE,
                         ResourceLocation.fromNamespaceAndPath(Spore.MODID, "textures/entity/umarmer_corrosive.png"));
            });
