...
public class BrainRemnantsRenderer extends BaseBlockEntityRenderer<BrainRemnantBlockEntity> {
    private final BlockEntityModel<BrainRemnantBlockEntity> brainModel;
    private static final ResourceLocation TEXTURE = ResourceLocation.fromNamespaceAndPath(Spore.MODID,"textures/block/brain_bits.png");
    private static final ResourceLocation ROASTED_TEXTURE = ResourceLocation.fromNamespaceAndPath(Spore.MODID,"textures/block/roasted_brain_bits.png");
    private static final ResourceLocation TENTACLE = ResourceLocation.fromNamespaceAndPath(Spore.MODID,"textures/block/tentacle_brain.png");
    ...
    public void renderTentacles(@NotNull BrainRemnantBlockEntity blockEntity,PoseStack pPoseStack,float partialTicks,MultiBufferSource pBuffer, int pPackedLight, int pPackedOverlay){
        ...
        this.brainModel.renderToBuffer(pPoseStack,vertexConsumer,pPackedLight, pPackedOverlay,-1);
        pPoseStack.popPose();
    }
}
