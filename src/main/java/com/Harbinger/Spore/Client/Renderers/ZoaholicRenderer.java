...
public class ZoaholicRenderer extends BaseBlockEntityRenderer<ZoaholicBlockEntity> {
    private static final ResourceLocation TEXTURE = ResourceLocation.fromNamespaceAndPath(Spore.MODID,"textures/block/zoaholic/zoaholic.png");
    private static final ResourceLocation GLASS = ResourceLocation.fromNamespaceAndPath(Spore.MODID,"textures/block/zoaholic/zoaholic_glass.png");
    private static final ResourceLocation BUTTONS = ResourceLocation.fromNamespaceAndPath(Spore.MODID,"textures/block/zoaholic/zoaholic_buttons.png");
