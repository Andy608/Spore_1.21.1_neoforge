    ...
    public static final Map<UsurperVariants, ResourceLocation> TEXTURE =
            Util.make(Maps.newEnumMap(UsurperVariants.class), (p_114874_) -> {
                p_114874_.put(UsurperVariants.DEFAULT,
                        ResourceLocation.fromNamespaceAndPath(Spore.MODID, "textures/entity/usurper.png"));
                p_114874_.put(UsurperVariants.BURST,
                        ResourceLocation.fromNamespaceAndPath(Spore.MODID, "textures/entity/burst_usurper.png"));
                p_114874_.put(UsurperVariants.SPRAY,
                        ResourceLocation.fromNamespaceAndPath(Spore.MODID, "textures/entity/spray_usurper.png"));
            });
