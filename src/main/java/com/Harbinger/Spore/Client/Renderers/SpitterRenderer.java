    ...
    public static final Map<SpitterVariants, ResourceLocation> TEXTURE =
            Util.make(Maps.newEnumMap(SpitterVariants.class), (p_114874_) -> {
                p_114874_.put(SpitterVariants.DEFAULT,
                         ResourceLocation.fromNamespaceAndPath(Spore.MODID, "textures/entity/spitter.png"));
                p_114874_.put(SpitterVariants.EXPLOSIVE,
                         ResourceLocation.fromNamespaceAndPath(Spore.MODID, "textures/entity/exploding_spitter.png"));
                p_114874_.put(SpitterVariants.BILE,
                         ResourceLocation.fromNamespaceAndPath(Spore.MODID, "textures/entity/spitter_bile.png"));
                p_114874_.put(SpitterVariants.DUAL,
                         ResourceLocation.fromNamespaceAndPath(Spore.MODID, "textures/entity/spitter_dual.png"));
                p_114874_.put(SpitterVariants.SNIPER,
                         ResourceLocation.fromNamespaceAndPath(Spore.MODID, "textures/entity/sniper_spitter.png"));
            });
