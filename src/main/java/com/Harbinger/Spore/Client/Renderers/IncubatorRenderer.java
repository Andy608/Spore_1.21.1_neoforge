...
public class IncubatorRenderer extends BaseBlockEntityRenderer<IncubatorBlockEntity> {
    private static final ResourceLocation TEXTURE = ResourceLocation.fromNamespaceAndPath(Spore.MODID,"textures/block/incubator/incubator.png");
    private static final ResourceLocation GLASS = ResourceLocation.fromNamespaceAndPath(Spore.MODID,"textures/block/incubator/incubator_glass.png");
    private static final ResourceLocation BUTTONS = ResourceLocation.fromNamespaceAndPath(Spore.MODID,"textures/block/incubator/incubator_buttons.png");
