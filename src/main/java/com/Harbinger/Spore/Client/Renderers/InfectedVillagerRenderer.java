    ...
    public static final Map<InfVillagerSkins, ResourceLocation> TEXTURE =
            Util.make(Maps.newEnumMap(InfVillagerSkins.class), (p_114874_) -> {
                p_114874_.put(InfVillagerSkins.DEFAULT,
                         ResourceLocation.fromNamespaceAndPath(Spore.MODID, "textures/entity/villager/in_villager.png"));
                p_114874_.put(InfVillagerSkins.DESERT,
                         ResourceLocation.fromNamespaceAndPath(Spore.MODID, "textures/entity/villager/inf_villager_desert.png"));
                p_114874_.put(InfVillagerSkins.JUNGLE,
                         ResourceLocation.fromNamespaceAndPath(Spore.MODID, "textures/entity/villager/inf_villager_jungle.png"));
                p_114874_.put(InfVillagerSkins.SAVANNA,
                         ResourceLocation.fromNamespaceAndPath(Spore.MODID, "textures/entity/villager/inf_villager_savanna.png"));
                p_114874_.put(InfVillagerSkins.SWAMP,
                         ResourceLocation.fromNamespaceAndPath(Spore.MODID, "textures/entity/villager/inf_villager_swamp.png"));
                p_114874_.put(InfVillagerSkins.TAIGA,
                         ResourceLocation.fromNamespaceAndPath(Spore.MODID, "textures/entity/villager/inf_villager_taiga.png"));
                p_114874_.put(InfVillagerSkins.TUNDRA,
                         ResourceLocation.fromNamespaceAndPath(Spore.MODID, "textures/entity/villager/inf_villager_tundra.png"));
            });
