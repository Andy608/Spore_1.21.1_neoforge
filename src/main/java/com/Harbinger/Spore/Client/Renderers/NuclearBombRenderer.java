...
public class NuclearBombRenderer<T extends NukeEntity> extends EntityRenderer<T> {
    private static final ResourceLocation TOP_TEXTURE = ResourceLocation.fromNamespaceAndPath(Spore.MODID, "textures/entity/bomb/top.png");
    private static final ResourceLocation FUNNEL_TEXTURE = ResourceLocation.fromNamespaceAndPath(Spore.MODID, "textures/entity/bomb/funnel.png");
    private static final ResourceLocation RING_TEXTURE = ResourceLocation.fromNamespaceAndPath(Spore.MODID, "textures/entity/bomb/fire_disk.png");
    ...
    public void renderTop(T bomb,PoseStack stack, MultiBufferSource bufferSource) {
        ...
        this.mushroomExplosionTop.renderToBuffer(stack, vertexconsumer, 15728640, OverlayTexture.NO_OVERLAY, -1);
        stack.popPose();
    }
    public void renderRing(T bomb,float ticks,PoseStack stack, MultiBufferSource bufferSource) {
        ...
        this.fireDiskModel.renderToBuffer(stack, vertexconsumer, 15728640, OverlayTexture.NO_OVERLAY, -1);
    ...
    public void renderFire(T bomb,float ticks,PoseStack stack, MultiBufferSource bufferSource) {
        ...
        this.funnelModel.renderToBuffer(stack, vertexconsumer, 15728640, OverlayTexture.NO_OVERLAY, -1);
        stack.popPose();
    }
