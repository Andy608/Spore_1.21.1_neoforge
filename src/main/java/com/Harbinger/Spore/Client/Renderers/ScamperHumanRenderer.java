    ...
    public static final Map<ScamperVariants, ResourceLocation> TEXTURE =
            Util.make(Maps.newEnumMap(ScamperVariants.class), (p_114874_) -> {
                p_114874_.put(ScamperVariants.DEFAULT,
                         ResourceLocation.fromNamespaceAndPath(Spore.MODID, "textures/entity/scamper.png"));
                p_114874_.put(ScamperVariants.VILLAGER,
                         ResourceLocation.fromNamespaceAndPath(Spore.MODID, "textures/entity/villager_scamper.png"));
                p_114874_.put(ScamperVariants.DROWNED,
                         ResourceLocation.fromNamespaceAndPath(Spore.MODID, "textures/entity/drowned_scamper.png"));
            });
